...
qx.Class.define("ext.ui.window.AbstractImageWindow",
{
  extend : ext.ui.window.Window,
  ...
  */
  ...
  construct : function(vCaption, vIcon, vWindowManager, vMinIcon, vContentIcon)
  {
  ...
  */
  ...
  statics : { ABSTRACT_CLASS : "ext.ui.window.AbstractImageWindow" },
