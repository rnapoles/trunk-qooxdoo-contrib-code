...
qx.Class.define("ext.ui.window.Window",
{
  ...
  */
  ...
  construct : function(vCaption, vIcon, vMinimisedIcon, vWindowManager)
  {
  ...
  */
  ...
  statics :
  {
    ...
    */
    ...
    BLOCKER_BUSY         : "busy-blocker",
    BLOCKER_FOCUS        : "focus-blocker",

    BLOCKER_CLIENT_DOC_Z : 3,

    BLOCKER_BUSY_Z       : 2,
    BLOCKER_FOCUS_Z      : 1,

    MINIMISE_ICON_SIZE   : 1,

    STATE_MINIMISED      : "minimised"
  },
  ...
  members :
  {
    ...
    */
    ...
    _applyStatus : function() {
      this.warn("qx.ui.window.Window's _applyStatus() is hidden by ext.ui.window.Window.");
    },
    ...
    */
    ...
    /** Override qx.ui.window.Window._applyModal so that we can apply our blocker. */
    _applyModal : function(propValue, propOldValue, propData)
    {
      // Inform blocker
    ...
    /**
     * Override qx.ui.window.Window._applyActive so that we can apply our blocker
     *  when this window is inactive.
     */
    _applyActive : function(propValue, propOldValue, propData)
    {
      // this.debug("_applyActive(1) propValue=" + propValue + ", propOldvalue=" + propOldValue + ", propData=" + propData);
      if (propOldValue)
      {
        if (this.getFocused()) {
     ...
     */
    _modifyIsFocusBlocked : function(propValue, propOldValue, propData)
    {
      if (propOldValue) {
     ...
     * @return {boolean} TODOC
     */
    _modifyIsBusyBlocked : function(propValue, propOldValue, propData)
    {
      if (propOldValue)
      {
    ...
    */
     ...
     *
     * @type member
     * @param blockerType {var} TODOC
     * @return {void} 
     */
    _block : function(blockerType)
    {
    ...
    */
     ...
     * @return {void} 
     */
    _onblockermousedown : function(e) {
      e.stopPropagation();
    },
     ...
     * @return {void} 
     */
    _onfocusblockerclick : function(e)
    {
      this.setActive(true);
      e.stopPropagation();
    },
    ...
    */
     ...
     * @return {void} 
     */
    _handleatomdblclick : function(e)
    {
