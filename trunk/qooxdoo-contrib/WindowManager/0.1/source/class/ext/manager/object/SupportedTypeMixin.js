...
*/
qx.Proto.getArraySize = function(vArray)
{
  var size = 0;
...
qx.Proto.getSupportedTypeDefs = function()
{
...
/*
  ...
  methods of qx.manager.object.ObjectManager are supported.
...
/*
  ...
  @return {qx.core.Object[]} An Objects that contains metadata describing the
          ...
          type.
*/
qx.Proto.getTypeDef = function(vClassname)
{
  var vDef = null;
