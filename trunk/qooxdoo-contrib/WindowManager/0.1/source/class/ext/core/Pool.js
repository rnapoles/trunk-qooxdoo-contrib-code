...
@author sbull
*/
qx.OO.defineClass("ext.core.Pool", qx.manager.object.ObjectManager,
function() {
...
*/
qx.OO.addProperty({ name : "poolSizes", type : "object"});
...
/*
  ...
  @return {Integer} The number of instance of type vClassname that are currently
          pooled.
*/
qx.Proto.countObjectsOfType = function(vClassname)
{
...
/*
  ...
  @return {Object} An instance of the requested type, or null if no such instance
          exists in the pool.
*/
qx.Proto.getObjectOfType = function(vClassname)
{
  var obj = null;
...
*/
qx.Proto.poolObject = function(vObject)
{
...
/*
  ...
  @return {Boolean} True if the pool is already full, otherwise false.  Note
          ...
          always return false.
*/
qx.Proto._isPoolFull = function(vClassname)
{
...
/*
  ...
  @param vClassname {String} The name of a type of Object.
*/
qx.Proto._ensurePoolOfType = function(vClassname)
{
  if (!this._pool[vClassname])
  {
