  ...
  */
  ...
  members :
  {
    ...
    __makeToolbar : function()
    {
      ...
      // -- playall button
      var playallb = new qx.ui.toolbar.Button("Play All", qxapp.AppFrame.Img_PlayAll_Default);
    ...
    leftReloadTree : function(e)
    {
      ...
      function buildSubTree(widgetR, modelR)
      {
        ...
        for (var i=0; i<children.length; i++)
        {
          ...
          {
            t = new qx.ui.tree.TreeFolder(that.polish(currNode.label), "qxapp/image/package18.gif");
          ...
          {
            t = new qx.ui.tree.TreeFile(that.polish(currNode.label), "qxapp/image/method_public18.gif");
        ...
        while (currNode = iter())
        {
          ...
          if (!(currNode.type && currNode.type == "test"))
          {
            if (handler.hasTests(currNode))
            {
              ...
              var t = new qx.ui.tree.TreeFolder(that.polish(fullName), "qxapp/image/package18.gif");
              widgetR.add(t);
              t.setUserData("modelLink", currNode);
              ...
              for (var i=0; i<children.length; i++)
              {
                ...
                {
                  var c = new qx.ui.tree.TreeFile(that.polish(children[i].label), "qxapp/image/class18.gif");
    ...
    __applyPlayAll : function(value, old)
    {
      if (value == true )
      {
        this.widgets["toolbar.playall"].setIcon(qxapp.AppFrame.Img_PlayAll_Stop);
      } else
      {
        this.widgets["toolbar.playall"].setIcon(qxapp.AppFrame.Img_PlayAll_Default);
