/* ************************************************************************
   ...
   Authors:
     * Derrell Lipman (derrell)
     ...
     modified by Christian Boulanger (cboulanger):
     - several functions which didn't return anything now return the
       node id. Changes are meant to be merged back to
       qx.ui.treevirtual.SimpleTreeDataModel in the 0.8 trunk
  ...
  */
  ...
  members :
  {
                    ...
                    parentNodeReference)
    {
      ...
      // Save the old node's parent id
      var oldParentId = this._nodeArr[moveNodeId].parentNodeId;

      // Replace this node's parent reference
      this._nodeArr[moveNodeId].parentNodeId = parentNodeId;
      
      return [ moveNodeId, oldParentId, parentNodeId ] ;
    },
