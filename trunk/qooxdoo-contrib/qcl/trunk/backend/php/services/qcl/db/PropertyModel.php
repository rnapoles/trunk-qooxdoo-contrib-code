...
class qcl_db_PropertyModel extends qcl_mvc_AbstractModel
{
 ...
 /**
   ...
   * qcl_db_XmlSchemaModel::getProperties();
   * @access private
   * @var array
   */
   ...
   * @param array|stdClass|qcl_db_XmlSchemaModel $data
   * @return array
   */
  function _getArrayData( $data )
  {
    if ( is_a( $data, "qcl_db_PropertyModel" ) )
    {
  ...
  function set( $first, $value=null, $id=null )
  {
    ...
    elseif ( is_a( $first, "qcl_db_XmlSchemaModel" ) )
    {
      $this->raiseError("Passing a qcl_db_XmlSchemaModel as argument is deprecated for ::set(). Use copySharedProperties() instead.");
   ...
   * @param qcl_db_XmlSchemaModel $that Other model
