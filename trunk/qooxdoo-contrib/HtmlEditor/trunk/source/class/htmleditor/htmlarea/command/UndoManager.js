 ...
 */
qx.Class.define("htmleditor.htmlarea.command.UndoManager",
{
  ...
  members :
  {
   ...
   __knownActionTypes : { command : true, content : true, custom : true },
    ...
    setContentDocument : function(doc)
    {
      ...
      qx.event.Registration.addListener(this.__doc, "mouseup", this.__handleMouseUp, this);
      
      if (qx.core.Variant.isSet("qx.client", "mshtml"))
      {
        /* Mouse down listener is used to look after internal changes like image resizing etc. */
        qx.event.Registration.addListener(this.__doc, "mousedown", this.__handleMouseDown, this);
      }
    },
	
	
	getCurrentRange : function() {
		return this.__commandManager.getCurrentRange();
	},
    ...
    execute : function(command, value)
    {
      ...
      if (this.commands[command])
      {
         ...
         */
        if (this.commands[command].passthrough)
        {
        ...
        else
        {
          ...
          this.__commandManager.focusAfterExecCommand();
    ...
    __undoCommand : function(undoInfo)
    {
      ...
      if (qx.core.Variant.isSet("qx.client", "mshtml"))
      {
        ...
        if (undoInfo.command == "inserthtml" && undoInfo.value == htmleditor.htmlarea.HtmlArea.simpleLinebreak)
        {
    ...
    __redoCommand : function(redoInfo)
    {
      ...
      if (qx.core.Variant.isSet("qx.client", "mshtml"))
      {
        ...
        if (redoInfo.command == "inserthtml" && redoInfo.value == htmleditor.htmlarea.HtmlArea.simpleLinebreak)
        {
    ...
    __populateCommandList : function()
    {
       ...
       * undo mechanism.
       */
      this.__commandManager.commands["backgroundcolor"].customUndo = true;
      this.__commandManager.commands["backgroundimage"].customUndo = true;      
      
      if (qx.core.Variant.isSet("qx.client", "gecko"))
      {
        this.__commandManager.commands["inserthyperlink"].customUndo = true;
      }
    },
      ...
      if (commandObject.customUndo)
      {
        ...
        switch(command)
        {
          ...
          case "inserthyperlink":
             ...
             */
            if (this.__editorInstance.getSelection() && 
                !this.__editorInstance.getSelection().isCollapsed)
            {
    ...
    _handleMouseDown : qx.core.Variant.select("qx.client", {
      "mshtml" : function(e)
      {
        var checkNode = e.getTarget();
        
        if (!(typeof checkNode == "undefined") && checkNode && checkNode.nodeName.toLowerCase() == "img" || checkNode.nodeName.toLowerCase() == "table" )
        {
    ...
    __updateUndoRedoState : function() 
    {
      qx.event.Timer.once(function(e) {
        this.__editorInstance.fireDataEvent("undoRedoState", { undo : this.isUndoPossible() ? 0 : -1, redo : this.isRedoPossible() ? 0 : -1 });
      }, this, 200);
    }
  },
  ...
  destruct : function()
  {
    ...
    this._disposeFields("__commandManager", "__editorInstance", "__undoStack", "__redoStack", "commands", "__doc", "__knownActionTypes", "__registeredHandler");
  }
});
