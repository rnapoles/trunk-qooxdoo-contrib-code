...
qx.Bootstrap.define("qx.core.Setting",{statics:{__a:{},define:function(key,defaultValue){if(defaultValue===undefined){throw new Error('Default value of setting "'+key+'" must be defined!');
}
...
qx.Bootstrap.define("qx.bom.client.Engine",{statics:{NAME:"",FULLVERSION:"0.0.0",VERSION:0.0,OPERA:false,WEBKIT:false,GECKO:false,MSHTML:false,UNKNOWN_ENGINE:false,UNKNOWN_VERSION:false,DOCUMENT_MODE:null,__d:function(){var engine="unknown";
var version="0.0.0";
...
qx.Bootstrap.define("qx.core.Variant",{statics:{__e:{},__f:{},compilerIsSet:function(){return true;
...
return retval;
},__i:function(v){return typeof v==="object"&&v!==null&&v instanceof Array;
},__j:function(v){return typeof v==="object"&&v!==null&&!(v instanceof Array);
...
qx.Bootstrap.define("qx.lang.Type",{statics:{__l:{"[object String]":"String","[object Array]":"Array","[object Object]":"Object","[object RegExp]":"RegExp","[object Number]":"Number","[object Boolean]":"Boolean","[object Date]":"Date","[object Function]":"Function","[object Error]":"Error"},getClass:function(value){var classString=Object.prototype.toString.call(value);
...
qx.Bootstrap.define("qx.core.Aspect",{statics:{__m:[],wrap:function(fullName,fcn,type){var before=[];
var after=[];
var reg=this.__m;
var entry;
...
return wrapper;
},addAdvice:function(fcn,position,type,name){this.__m.push({fcn:fcn,pos:position==="before"?-1:1,type:type,name:name});
}}});
...
qx.Bootstrap.define("qx.core.ObjectRegistry",{statics:{inShutDown:false,__Q:{},__R:0,__S:[],register:function(obj){var registry=this.__Q;
...
qx.Bootstrap.define("qx.event.Manager",{construct:function(win,registration){this.__V=win;
...
qx.util.DisposeUtil.disposeMap(this,"__Y");
qx.util.DisposeUtil.disposeMap(this,"__ba");
...
qx.Bootstrap.define("qx.event.Registration",{statics:{__bg:{},getManager:function(target){if(target==null){{};
target=window;
...
qx.Bootstrap.define("qx.log.appender.RingBuffer",{construct:function(maxMessages){this.__bj=[];
...
qx.Bootstrap.define("qx.log.Logger",{statics:{__bm:"debug",setLevel:function(value){this.__bm=value;
...
delete appender.$$id;
},debug:function(object,message){this.__br("debug",arguments);
},info:function(object,message){this.__br("info",arguments);
},warn:function(object,message){this.__br("warn",arguments);
},error:function(object,message){this.__br("error",arguments);
},trace:function(object){this.__br("info",[object,qx.dev.StackTrace.getStackTrace().join("\n")]);
...
}},__bs:function(value){if(value===undefined){return "undefined";
...
}},properties:{backgroundColor:{check:"Color",nullable:true,apply:"_applyStyle"}},members:{__bG:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
...
}},properties:{baseImage:{check:"String",nullable:true,apply:"_applyBaseImage"}},members:{__bH:null,__bI:null,__bJ:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
...
var prefix=split[1];
var ext=split[2];
var images=this.__bI={tl:prefix+"-tl"+ext,t:prefix+"-t"+ext,tr:prefix+"-tr"+ext,bl:prefix+"-bl"+ext,b:prefix+"-b"+ext,br:prefix+"-br"+ext,l:prefix+"-l"+ext,c:prefix+"-c"+ext,r:prefix+"-r"+ext};
...
qx.Bootstrap.define("qx.bom.client.Platform",{statics:{NAME:"",WIN:false,MAC:false,UNIX:false,UNKNOWN_PLATFORM:false,__bM:function(){var input=navigator.platform;
...
qx.Bootstrap.define("qx.bom.client.System",{statics:{NAME:"",SP1:false,SP2:false,WIN95:false,WIN98:false,WINME:false,WINNT4:false,WIN2000:false,WINXP:false,WIN2003:false,WINVISTA:false,WINCE:false,LINUX:false,SUNOS:false,FREEBSD:false,NETBSD:false,OPENBSD:false,OSX:false,OS9:false,SYMBIAN:false,NINTENDODS:false,PSP:false,IPHONE:false,UNKNOWN_SYSTEM:false,__bN:{"Windows NT 6.0":"winvista","Windows NT 5.2":"win2003","Windows NT 5.1":"winxp","Windows NT 5.0":"win2000","Windows 2000":"win2000","Windows NT 4.0":"winnt4","Win 9x 4.90":"winme","Windows CE":"wince","Windows 98":"win98","Win98":"win98","Windows 95":"win95","Win95":"win95","Linux":"linux","FreeBSD":"freebsd","NetBSD":"netbsd","OpenBSD":"openbsd","SunOS":"sunos","Symbian System":"symbian","Nitro":"nintendods","PSP":"sonypsp","Mac OS X 10_5":"osx5","Mac OS X 10.5":"osx5","Mac OS X 10_4":"osx4","Mac OS X 10.4":"osx4","Mac OS X 10_3":"osx3","Mac OS X 10.3":"osx3","Mac OS X 10_2":"osx2","Mac OS X 10.2":"osx2","Mac OS X 10_1":"osx1","Mac OS X 10.1":"osx1","Mac OS X 10_0":"osx0","Mac OS X 10.0":"osx0","Mac OS X":"osx","Mac OS 9":"os9"},__bO:function(){var agent=navigator.userAgent;
var str=[];
...
qx.Bootstrap.define("qx.lang.Generics",{statics:{__bP:{"Array":["join","reverse","sort","push","pop","shift","unshift","splice","concat","slice","indexOf","lastIndexOf","forEach","map","filter","some","every"],"String":["quote","substring","toLowerCase","toUpperCase","charAt","charCodeAt","indexOf","lastIndexOf","toLocaleLowerCase","toLocaleUpperCase","localeCompare","match","search","replace","split","substr","concat","slice"]},__bQ:function(obj,func){return function(s){return obj.prototype[func].apply(s,Array.prototype.slice.call(arguments,1));
};
...
qx.Bootstrap.define("qx.event.GlobalError",{statics:{setErrorHandler:function(callback,context){this.__bS=callback||null;
this.__bT=context||window;

if(qx.core.Setting.get("qx.globalErrorHandling")==="on"){if(callback&&!window.onerror){window.onerror=qx.lang.Function.bind(this.__bU,this);
}
...
qx.Class.define("qx.event.type.Data",{extend:qx.event.type.Event,members:{__bY:null,__ca:null,init:function(data,old,cancelable){arguments.callee.base.call(this,false,cancelable);
this.__bY=data;
this.__ca=old;
return this;
...
},_initObserver:function(){if(qx.$$domReady||document.readyState=="complete"){this.__cb=true;
this.__cg();
...
},"webkit":function(error){if(error.sourceURL&&error.line){return [this.__ch(error.sourceURL)+":"+error.line];
}else{return [];
...
}}),__ch:function(fileName){var scriptDir="/source/class/";
...
}},properties:{size:{check:"Integer",init:Infinity}},members:{__ci:null,getObject:function(clazz){if(this.$$disposed){return;
}
...
qx.Class.define("qx.data.SingleValueBinding",{statics:{DEBUG_ON:false,__cj:{},bind:function(sourceObject,sourcePropertyChain,targetObject,targetProperty,options){var propertyNames=sourcePropertyChain.split(".");
...
context.listenerIds[j]=this.__cr(source,"change",context.targetObject,context.targetProperty,context.options,context.arrayIndexValues[j]);
...
if(lastProperty.charAt(lastProperty.length-1)=="]"){this.__cn(targetObject,targetPropertyChain,null);
return;
...
}}},__co:function(targetObject,targetPropertyChain){var properties=targetPropertyChain.split(".");
...
},toString:function(){return this.__cw+": "+this.message;
}}});
...
qx.Class.define("qx.bom.element.Decoration",{statics:{DEBUG:false,__pk:{},__cz:qx.core.Variant.isSet("qx.client","mshtml")&&qx.bom.client.Engine.VERSION<9,__cA:qx.core.Variant.select("qx.client",{"mshtml":{"scale-x":true,"scale-y":true,"scale":true,"no-repeat":true},"default":null}),__cB:{"scale-x":"img","scale-y":"img","scale":"img","repeat":"div","no-repeat":"div","repeat-x":"div","repeat-y":"div"},update:function(element,source,repeat,style){var tag=this.getTagName(repeat,source);
...
}},getTagName:function(repeat,source){if(qx.core.Variant.isSet("qx.client","mshtml")){if(source&&this.__cz&&this.__cA[repeat]&&qx.lang.String.endsWith(source,".png")){return "div";
...
{};
var result;
if(this.__cz&&this.__cA[repeat]&&format==="png"){result=this.__BB(style,repeat,source);
}else{if(repeat==="scale"){result=this.__BC(style,repeat,source);
}else if(repeat==="scale-x"||repeat==="scale-y"){result=this.__BD(style,repeat,source);
}else{result=this.__BG(style,repeat,source);
}}return result;
},__Bz:function(style,width,height){if(style.width==null&&width!=null){style.width=width+"px";
}
...
}}},isAlphaImageLoaderEnabled:qx.core.Variant.select("qx.client",{"mshtml":function(){return qx.bom.element.Decoration.__cz;
...
qx.Class.define("qx.bom.element.Cursor",{statics:{__cE:qx.core.Variant.select("qx.client",{"mshtml":{"cursor":"hand","ew-resize":"e-resize","ns-resize":"n-resize","nesw-resize":"ne-resize","nwse-resize":"nw-resize"},"opera":{"col-resize":"e-resize","row-resize":"n-resize","ew-resize":"e-resize","ns-resize":"n-resize","nesw-resize":"ne-resize","nwse-resize":"nw-resize"},"default":{}}),compile:function(cursor){return "cursor:"+(this.__cE[cursor]||cursor)+";";
...
qx.Class.define("qx.bom.element.BoxSizing",{statics:{__cF:qx.core.Variant.select("qx.client",{"mshtml":null,"webkit":["boxSizing","KhtmlBoxSizing","WebkitBoxSizing"],"gecko":["MozBoxSizing"],"opera":["boxSizing"]}),__cG:qx.core.Variant.select("qx.client",{"mshtml":null,"webkit":["box-sizing","-khtml-box-sizing","-webkit-box-sizing"],"gecko":["-moz-box-sizing"],"opera":["box-sizing"]}),__cH:{tags:{button:true,select:true},types:{search:true,button:true,submit:true,reset:true,checkbox:true,radio:true}},__cI:function(element){var map=this.__cH;
...
}}),get:qx.core.Variant.select("qx.client",{"mshtml":function(element){if(qx.bom.Document.isStandardMode(qx.dom.Node.getDocument(element))){if(!this.__cI(element)){return "content-box";
}}return "border-box";
...
qx.Class.define("qx.bom.element.Overflow",{statics:{__cJ:null,getScrollbarWidth:function(){if(this.__cJ!==null){return this.__cJ;
}var Style=qx.bom.element.Style;
...
}},get:qx.core.Variant.select("qx.client",{"mshtml":function(element,name,mode,smart){var hints=this.__cC;
name=hints.styleNames[name]||name;
...
qx.Bootstrap.define("qx.bom.client.Feature",{statics:{STANDARD_MODE:false,QUIRKS_MODE:false,CONTENT_BOX:false,BORDER_BOX:false,SVG:false,CANVAS:false,VML:false,XPATH:false,AIR:false,GEARS:false,SSL:false,__cK:function(){this.QUIRKS_MODE=this.__cL();
...
qx.Class.define("qx.util.ResourceManager",{extend:qx.core.Object,type:"singleton",statics:{__cM:qx.$$resources||{},__cN:{}},members:{has:function(id){return !!arguments.callee.self.__cM[id];
...
if(qx.core.Variant.isSet("qx.client","mshtml")&&qx.bom.client.Feature.SSL){urlPrefix=arguments.callee.self.__cN[lib];
...
statics.__cN[lib]=url.substring(0,url.lastIndexOf("/"));
...
}statics.__cN[lib]=href.substring(0,href.lastIndexOf("/")+1);
}}}}}});
qx.Bootstrap.define("qx.io2.ImageLoader",{statics:{__cO:{},__cP:{width:null,height:null},__cQ:/\.(png|gif|jpg|jpeg|bmp)\b/i,isLoaded:function(source){var entry=this.__cO[source];
...
}}),__cS:qx.core.Variant.select("qx.client",{"gecko":function(element){return element.naturalWidth;
},"default":function(element){return element.width;
}}),__cT:qx.core.Variant.select("qx.client",{"gecko":function(element){return element.naturalHeight;
},"default":function(element){return element.height;
}})}});
qx.Class.define("qx.bom.element.Background",{statics:{__cU:["background-image:url(",null,");","background-position:",null,";","background-repeat:",null,";"],__cV:{backgroundImage:null,backgroundPosition:null,backgroundRepeat:null},__cW:function(left,top){var Engine=qx.bom.client.Engine;
...
qx.Class.define("qx.core.Init",{statics:{getApplication:function(){return this.__dd||null;
...
}}},defer:function(statics){qx.event.Registration.addListener(window,"ready",statics.__dc,statics);
qx.event.Registration.addListener(window,"shutdown",statics.__df,statics);
qx.event.Registration.addListener(window,"beforeunload",statics.__de,statics);
}});
...
qx.Class.define("qx.application.AbstractGui",{type:"abstract",extend:qx.core.Object,implement:[qx.application.IApplication],include:qx.locale.MTranslation,members:{__dg:null,_createRootWidget:function(){throw new Error("Abstract method call");
...
qx.Class.define("qx.theme.manager.Decoration",{type:"singleton",extend:qx.core.Object,properties:{theme:{check:"Theme",nullable:true,apply:"_applyTheme"}},members:{__dh:null,resolve:function(value){if(!value){return null;
}
...
if(!value){this.__dh={};
}}},destruct:function(){this._disposeMap("__dh");
}});
...
},_applyBold:function(value,old){this.__dl=value===null?null:value?"bold":"normal";
},_applyItalic:function(value,old){this.__dm=value===null?null:value?"italic":"normal";
...
this.__dp={};
this.__dq={};
},properties:{theme:{check:"Theme",nullable:true,event:"changeTheme",apply:"_applyTheme"}},members:{__dr:{},__dp:null,__dq:null,_applyTheme:function(value,old){this.__dq={};
this.__dp={};
...
}else if(typeof entry==="string"){return this.__ds(entry,theme,defaultId);
...
qx.event.Registration.addListener(document.body,"mouseover",this.__dD,this,true);
this.__dt=new qx.event.Timer();
this.__dt.addListener("interval",this.__dA,this);
this.__du=new qx.event.Timer();
this.__du.addListener("interval",this.__dB,this);
this.__dv={left:0,top:0};
},properties:{current:{check:"qx.ui.tooltip.ToolTip",nullable:true,apply:"_applyCurrent"},showInvalidTooltips:{check:"Boolean",init:true}},members:{__dv:null,__du:null,__dt:null,__dw:null,__dx:null,__dy:function(){if(!this.__dw){this.__dw=new qx.ui.tooltip.ToolTip().set({rich:true});
}return this.__dw;
},__dz:function(){if(!this.__dx){this.__dx=new qx.ui.tooltip.ToolTip().set({appearance:"tooltip-error"});
...
Registration.addListener(el,"mouseout",this.__dE,this,true);
Registration.addListener(el,"focusout",this.__dF,this,true);
Registration.addListener(el,"mousemove",this.__dC,this,true);
}else{Registration.removeListener(el,"mouseout",this.__dE,this,true);
Registration.removeListener(el,"focusout",this.__dF,this,true);
Registration.removeListener(el,"mousemove",this.__dC,this,true);
...
}}},destruct:function(){qx.event.Registration.removeListener(document.body,"mouseover",this.__dD,this,true);
this._disposeObjects("__dt","__du","__dw");
this.__dv=null;
}});
...
timer.start();
return timer;
}},properties:{enabled:{init:true,check:"Boolean",apply:"_applyEnabled"},interval:{check:"Integer",init:1000,apply:"_applyInterval"}},members:{__dH:null,__dG:null,_applyInterval:function(value,old){if(this.getEnabled()){this.restart();
...
this.__dQ={};
},statics:{MAX_SIZE:15,__dR:"$$nopool$$"},members:{__dQ:null,getDecoratorElement:function(decorator){var clazz=qx.ui.core.DecoratorFactory;
...
if(bounds){this.__dY.setStyles({width:bounds.width+"px",height:bounds.height+"px"});
...
this.__dY.setStyles({width:bounds.width+"px",height:bounds.height+"px"});
...
}},_applyToolTipText:function(value,old){if(qx.core.Variant.isSet("qx.dynlocale","on")){if(this.__eb){return;
}var manager=qx.locale.Manager.getInstance();
this.__eb=manager.addListener("changeLocale",function(){if(value&&value.translate){this.setToolTipText(value.translate());
}},this);
...
selector=this.__em=id.reverse().join("/").replace(/#[0-9]+/g,"");
...
}}this.fireDataEvent("syncAppearance",this.__el);
...
}},destruct:function(){if(!qx.core.ObjectRegistry.inShutDown){if(qx.core.Variant.isSet("qx.dynlocale","on")){if(this.__eb){qx.locale.Manager.getInstance().removeListenerById(this.__eb);
...
}else{this._disposeArray("__ef");
this._disposeObjects("__dW","__dX");
}this._disposeArray("__eh");
this.__el=this.__eo=null;
this._disposeObjects("__ec","__dS","__dT","__dY");
}});
...
qx.event.Idle.getInstance().addListener("interval",this.__ep);
this.addListener("disappear",function(){if(this.__ep){qx.event.Idle.getInstance().removeListener("interval",this.__ep);
this.__ep=null;
}},this);
...
if(size==null){this.addListenerOnce("appear",function(){this.__eq(callback);
},this);
...
}},destruct:function(){if(this.__ep){qx.event.Idle.getInstance().removeListener("interval",this.__ep);
}}});
...
qx.Class.define("qx.ui.core.queue.Layout",{statics:{__es:{},remove:function(widget){delete this.__es[widget.$$hash];
...
qx.Class.define("qx.util.DeferredCallManager",{extend:qx.core.Object,type:"singleton",construct:function(){this.__ey={};
...
},_mshtmlVisibilitySort:qx.core.Variant.select("qx.client",{"mshtml":function(a,b){var al=a.__eO;
var bl=b.__eO;
...
{};
obj.__eO.style.display=obj.__eR?"":"none";
...
if(!helper){helper=qx.html.Element.__fm=document.createElement("div");
...
this.scrollToX(0);
this.scrollToY(0);
this.addListener("scroll",this.__fo,this);
},enableScrolling:function(){this.removeListener("scroll",this.__fo,this);
...
qx.html.Element._scheduleFlush("element");
},focus:function(){this.__fp("focus");
},blur:function(){this.__fp("blur");
},activate:function(){this.__fp("activate");
},deactivate:function(){this.__fp("deactivate");
},capture:function(containerCapture){this.__fp("capture",[containerCapture!==false]);
...
}}this._disposeArray("__fe");
this.__fb=this.__fa=this.__fd=this.__fc=this.__eX=this.__eW=this.__eY=this.__eO=this.__fg=this.__eS=this.__eT=null;
}});
qx.Class.define("qx.ui.core.queue.Manager",{statics:{__fr:false,__fs:{},__ft:0,MAX_RETRIES:10,scheduleFlush:function(job){var self=qx.ui.core.queue.Manager;
self.__fs[job]=true;
...
if(qx.core.Variant.isSet("qx.client","gecko")){this.__fz=this.__fy;
...
}if(this.__fy){qx.event.Registration.fireEvent(this.__fy,"useraction",qx.event.type.Data,["keyinput"]);
...
}}}if(this.__fy){qx.event.Registration.fireEvent(this.__fy,"useraction",qx.event.type.Data,[type]);
...
Event.addNativeListener(this.__fz,"keyup",this.__fB);
Event.addNativeListener(this.__fz,"keydown",this.__fB);
Event.addNativeListener(this.__fz,"keypress",this.__fD);
},_stopKeyObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__fz,"keyup",this.__fB);
Event.removeNativeListener(this.__fz,"keydown",this.__fB);
Event.removeNativeListener(this.__fz,"keypress",this.__fD);

for(var key in (this.__fC||{})){var listener=this.__fC[key];
Event.removeNativeListener(listener.target,"keypress",listener.callback);
}delete (this.__fC);
},__fF:qx.event.GlobalError.observeMethod(qx.core.Variant.select("qx.client",{"mshtml":function(domEvent){domEvent=window.event||domEvent;
var keyCode=domEvent.keyCode;
var charCode=0;
var type=domEvent.type;
if(!(this.__fA[keyCode]=="keydown"&&type=="keydown")){this._idealKeyHandler(keyCode,charCode,type,domEvent);
...
if(!(this.__fA[keyIdentifier]=="keydown"&&type=="keydown")){this._idealKeyHandler(keyCode,charCode,type,domEvent);
...
}})),__fG:qx.core.Variant.select("qx.client",{"gecko":function(target,type,keyCode){if(type==="keydown"&&(keyCode==33||keyCode==34||keyCode==38||keyCode==40)&&target.type=="text"&&target.tagName.toLowerCase()==="input"&&target.getAttribute("autoComplete")!=="off"){if(!this.__fC){this.__fC={};
...
}},"default":null}),__fH:qx.event.GlobalError.observeMethod(qx.core.Variant.select("qx.client",{"mshtml":function(domEvent){domEvent=window.event||domEvent;
...
}qx.event.Registration.fireEvent(this.__fJ,"useraction",qx.event.type.Data,[type||domEvent.type]);
},_initButtonObserver:function(){this.__fL=qx.lang.Function.listener(this._onButtonEvent,this);
var Event=qx.bom.Event;
Event.addNativeListener(this.__fK,"mousedown",this.__fL);
Event.addNativeListener(this.__fK,"mouseup",this.__fL);
Event.addNativeListener(this.__fK,"click",this.__fL);
Event.addNativeListener(this.__fK,"dblclick",this.__fL);
Event.addNativeListener(this.__fK,"contextmenu",this.__fL);
},_initMoveObserver:function(){this.__fM=qx.lang.Function.listener(this._onMoveEvent,this);
var Event=qx.bom.Event;
Event.addNativeListener(this.__fK,"mousemove",this.__fM);
Event.addNativeListener(this.__fK,"mouseover",this.__fM);
Event.addNativeListener(this.__fK,"mouseout",this.__fM);
...
Event.removeNativeListener(this.__fK,"mousedown",this.__fL);
Event.removeNativeListener(this.__fK,"mouseup",this.__fL);
Event.removeNativeListener(this.__fK,"click",this.__fL);
Event.removeNativeListener(this.__fK,"dblclick",this.__fL);
Event.removeNativeListener(this.__fK,"contextmenu",this.__fL);
},_stopMoveObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__fK,"mousemove",this.__fM);
Event.removeNativeListener(this.__fK,"mouseover",this.__fM);
Event.removeNativeListener(this.__fK,"mouseout",this.__fM);
...
}),_onWheelEvent:qx.event.GlobalError.observeMethod(function(domEvent){this.__fQ(domEvent,"mousewheel");
}),__fR:qx.core.Variant.select("qx.client",{"webkit":function(domEvent,type,target){if(qx.bom.client.Engine.VERSION<530){if(type=="contextmenu"){this.__fQ(domEvent,"mouseup",target);
}}},"default":null}),__fS:qx.core.Variant.select("qx.client",{"opera":function(domEvent,type,target){if(type=="mouseup"&&domEvent.button==2){this.__fQ(domEvent,"contextmenu",target);
}},"default":null}),__fT:qx.core.Variant.select("qx.client",{"mshtml":function(domEvent,type,target){if(type=="mouseup"&&this.__fO=="click"){this.__fQ(domEvent,"mousedown",target);
}else if(type=="dblclick"){this.__fQ(domEvent,"click",target);
}},"default":null}),__fU:qx.core.Variant.select("qx.client",{"mshtml":null,"default":function(domEvent,type,target){switch(type){case "mousedown":this.__fP=target;
break;
case "mouseup":if(target!==this.__fP){var commonParent=qx.dom.Hierarchy.getCommonParent(target,this.__fP);
this.__fQ(domEvent,"click",commonParent);
...
this.__fV.addListener(this.__fW,"mousedown",this._onMouseDown,this);
this.__gj();
...
this.__gl("droprequest",this.__fY,this.__fX,false);
}
...
if(this.__gq){if(keys.Shift&&keys.Ctrl&&actions.alias){current="alias";
...
this.__gl("dragchange",this.__fY,this.__fX,false);
...
},__gm:function(elem){while(elem&&elem.nodeType==1){if(elem.getAttribute("qxDraggable")=="on"){return elem;
}elem=elem.parentNode;
}return null;
},__gn:function(elem){while(elem&&elem.nodeType==1){if(elem.getAttribute("qxDroppable")=="on"){return elem;
}elem=elem.parentNode;
}return null;
},__go:function(){this.__fY=null;
this.__fV.removeListener(this.__fW,"mousemove",this._onMouseMove,this,true);
this.__fV.removeListener(this.__fW,"mouseup",this._onMouseUp,this,true);
qx.event.Registration.removeListener(window,"blur",this._onWindowBlur,this);
this.__gj();
},__gp:function(){if(this.__gg){this.__fV.removeListener(this.__fW,"mouseover",this._onMouseOver,this,true);
this.__fV.removeListener(this.__fW,"mouseout",this._onMouseOut,this,true);
this.__fV.removeListener(this.__fW,"keydown",this._onKeyDown,this,true);
this.__fV.removeListener(this.__fW,"keyup",this._onKeyUp,this,true);
this.__gl("dragend",this.__fY,this.__fX,false);
this.__gg=false;
}this.__gq=false;
this.__fX=null;
this.__go();
...
switch(iden){case "Alt":case "Ctrl":case "Shift":if(!this.__gc[iden]){this.__gc[iden]=true;
this.__gk();
}}},_onKeyUp:function(e){var iden=e.getKeyIdentifier();

switch(iden){case "Alt":case "Ctrl":case "Shift":if(this.__gc[iden]){this.__gc[iden]=false;
this.__gk();
...
this.__fY=dragable;
this.__fV.addListener(this.__fW,"mousemove",this._onMouseMove,this,true);
this.__fV.addListener(this.__fW,"mouseup",this._onMouseUp,this,true);
qx.event.Registration.addListener(window,"blur",this._onWindowBlur,this);
}},_onMouseUp:function(e){if(this.__gq){this.__gl("drop",this.__fX,this.__fY,false,e);
}if(this.__gg){e.stopPropagation();
}this.__gp();
},_onMouseMove:function(e){if(this.__gg){if(!this.__gl("drag",this.__fY,this.__fX,true,e)){this.__gp();
}}else{if(Math.abs(e.getDocumentLeft()-this.__gh)>3||Math.abs(e.getDocumentTop()-this.__gi)>3){if(this.__gl("dragstart",this.__fY,this.__fX,true,e)){this.__gg=true;
this.__fV.addListener(this.__fW,"mouseover",this._onMouseOver,this,true);
this.__fV.addListener(this.__fW,"mouseout",this._onMouseOut,this,true);
this.__fV.addListener(this.__fW,"keydown",this._onKeyDown,this,true);
this.__fV.addListener(this.__fW,"keyup",this._onKeyUp,this,true);
var keys=this.__gc;
keys.Ctrl=e.isCtrlPressed();
keys.Shift=e.isShiftPressed();
keys.Alt=e.isAltPressed();
this.__gk();
}else{this.__gl("dragend",this.__fY,this.__fX,false);
this.__go();
}}}},_onMouseOver:function(e){var target=e.getTarget();
var dropable=this.__gn(target);

if(dropable&&dropable!=this.__fX){this.__gq=this.__gl("dragover",dropable,this.__fY,true,e);
this.__fX=dropable;
this.__gk();
}},_onMouseOut:function(e){var dropable=this.__gn(e.getTarget());
var newDropable=this.__gn(e.getRelatedTarget());

if(dropable&&dropable!==newDropable&&dropable==this.__fX){this.__gl("dragleave",this.__fX,newDropable,false,e);
this.__fX=null;
this.__gq=false;
...
qx.Class.define("qx.bom.Element",{statics:{__gu:{"onload":true,"onpropertychange":true,"oninput":true,"onchange":true,"name":true,"type":true,"checked":true,"disabled":true},create:function(name,attributes,win){if(!win){win=window;
}
...
this.__gF(this._window,null,"blur",false);
}},__gH:function(){if(!this._windowFocused){this._windowFocused=true;
this.__gF(this._window,null,"focus",false);
}},_initObserver:qx.core.Variant.select("qx.client",{"gecko":function(){this.__gv=qx.lang.Function.listener(this.__gN,this);
...
this._document.addEventListener("mousedown",this.__gv,true);
this._document.addEventListener("mouseup",this.__gw,true);
this._window.addEventListener("focus",this.__gx,true);
this._window.addEventListener("blur",this.__gy,true);
this._window.addEventListener("draggesture",this.__gz,true);
...
this._document.attachEvent("onmousedown",this.__gv);
this._document.attachEvent("onmouseup",this.__gw);
this._document.attachEvent("onfocusin",this.__gB);
this._document.attachEvent("onfocusout",this.__gC);
this._document.attachEvent("onselectstart",this.__gA);
...
this._document.addEventListener("mousedown",this.__gv,true);
this._document.addEventListener("mouseup",this.__gw,true);
this._document.addEventListener("selectstart",this.__gA,false);
this._window.addEventListener("DOMFocusOut",this.__gC,true);
this._window.addEventListener("focus",this.__gx,true);
this._window.addEventListener("blur",this.__gy,true);
...
this._document.addEventListener("mousedown",this.__gv,true);
this._document.addEventListener("mouseup",this.__gw,true);
this._window.addEventListener("DOMFocusIn",this.__gB,true);
this._window.addEventListener("DOMFocusOut",this.__gC,true);
}}),_stopObserver:qx.core.Variant.select("qx.client",{"gecko":function(){this._document.removeEventListener("mousedown",this.__gv,true);
this._document.removeEventListener("mouseup",this.__gw,true);
this._window.removeEventListener("focus",this.__gx,true);
this._window.removeEventListener("blur",this.__gy,true);
this._window.removeEventListener("draggesture",this.__gz,true);
},"mshtml":function(){this._document.detachEvent("onmousedown",this.__gv);
this._document.detachEvent("onmouseup",this.__gw);
this._document.detachEvent("onfocusin",this.__gB);
this._document.detachEvent("onfocusout",this.__gC);
this._document.detachEvent("onselectstart",this.__gA);
},"webkit":function(){this._document.removeEventListener("mousedown",this.__gv,true);
this._document.removeEventListener("selectstart",this.__gA,false);
this._window.removeEventListener("DOMFocusIn",this.__gB,true);
this._window.removeEventListener("DOMFocusOut",this.__gC,true);
this._window.removeEventListener("focus",this.__gx,true);
this._window.removeEventListener("blur",this.__gy,true);
},"opera":function(){this._document.removeEventListener("mousedown",this.__gv,true);
this._window.removeEventListener("DOMFocusIn",this.__gB,true);
this._window.removeEventListener("DOMFocusOut",this.__gC,true);
this._window.removeEventListener("focus",this.__gx,true);
this._window.removeEventListener("blur",this.__gy,true);
}}),__gI:qx.event.GlobalError.observeMethod(qx.core.Variant.select("qx.client",{"gecko":function(e){if(!this.__gU(e.target)){qx.bom.Event.preventDefault(e);
}},"default":null})),__gJ:qx.event.GlobalError.observeMethod(qx.core.Variant.select("qx.client",{"mshtml":function(e){this.__gH();
...
}}},"default":null})),__gK:qx.event.GlobalError.observeMethod(qx.core.Variant.select("qx.client",{"mshtml":function(e){if(!e.toElement){this.__gG();
this.resetFocus();
this.resetActive();
...
if(target===this.getActive()){this.resetActive();
}}},"default":null})),__gL:qx.event.GlobalError.observeMethod(qx.core.Variant.select("qx.client",{"gecko":function(e){if(e.target===this._window||e.target===this._document){this.__gG();
this.resetActive();
this.resetFocus();
...
this.resetActive();
this.resetFocus();
}},"default":null})),__gM:qx.event.GlobalError.observeMethod(qx.core.Variant.select("qx.client",{"gecko":function(e){var target=e.target;
...
this.tryActivate(target);
}},"default":null})),__gN:qx.event.GlobalError.observeMethod(qx.core.Variant.select("qx.client",{"gecko":function(e){var target=e.target;
var focusTarget=this.__gS(target);
...
if(focusTarget){if(!this.__gU(target)){target.unselectable="on";
document.selection.empty();
focusTarget.focus();
}}else{qx.bom.Event.preventDefault(e);
if(!this.__gU(target)){target.unselectable="on";
}}},"webkit":function(e){var target=e.target;
var focusTarget=this.__gS(target);
...
}},"default":null})),__gO:qx.event.GlobalError.observeMethod(qx.core.Variant.select("qx.client",{"mshtml":function(e){var target=e.srcElement;
...
},"default":null})),__gP:qx.event.GlobalError.observeMethod(qx.core.Variant.select("qx.client",{"mshtml|webkit":function(target){var focusedElement=this.getFocus();
...
}})),__gQ:qx.event.GlobalError.observeMethod(qx.core.Variant.select("qx.client",{"mshtml|webkit":function(e){var target=qx.bom.client.Engine.MSHTML?e.srcElement:e.target;

if(!this.__gU(target)){qx.bom.Event.preventDefault(e);
}},"default":null})),__gR:function(el){var index=qx.bom.element.Attribute.get(el,"tabIndex");
...
},__gS:function(el){while(el&&el.nodeType===1){if(el.getAttribute("qxKeepFocus")=="on"){return null;
}
...
},__gU:function(node){while(node&&node.nodeType===1){var attr=node.getAttribute("qxSelectable");

if(attr!=null){return attr==="on";
}node=node.parentNode;
}return true;
},_applyActive:function(value,old){if(old){this.__gF(old,value,"deactivate",true);
}
if(value){this.__gF(value,old,"activate",true);
}},_applyFocus:function(value,old){if(old){this.__gF(old,value,"focusout",true);
}
if(value){this.__gF(value,old,"focusin",true);
}if(old){this.__gF(old,value,"blur",false);
}
if(value){this.__gF(value,old,"focus",false);
}}},destruct:function(){this._stopObserver();
...
return clone;
},__gW:qx.core.Variant.select("qx.client",{"mshtml":{1:"left",2:"right",4:"middle"},"default":{0:"left",2:"right",1:"middle"}}),stop:function(){this.stopPropagation();
},getButton:function(){switch(this._type){case "click":case "dblclick":return "left";
case "contextmenu":return "right";
default:return this.__gW[this._native.button]||"none";
...
manager.addListener(this.__gX,"blur",this.releaseCapture,this);
manager.addListener(this.__gX,"focus",this.releaseCapture,this);
manager.addListener(this.__gX,"scroll",this.releaseCapture,this);
...
this.__ha=element;
this.__gY.fireEvent(element,"capture",qx.event.type.Event,[true,false]);
},getCaptureElement:function(){return this.__ha;
},releaseCapture:function(){var element=this.__ha;

if(!element){return;
}this.__ha=null;
this.__gY.fireEvent(element,"losecapture",qx.event.type.Event,[true,false]);
...
qx.Class.define("qx.bom.element.Location",{statics:{__hd:function(elem,style){return qx.bom.element.Style.get(elem,style,qx.bom.element.Style.COMPUTED_MODE,false);
...
},__hg:qx.core.Variant.select("qx.client",{"mshtml":function(elem){var doc=qx.dom.Node.getDocument(elem);
var body=doc.body;
var left=0;
var top=0;
...
if(qx.bom.client.Feature.STANDARD_MODE){left+=this.__he(body,"borderLeftWidth");
top+=this.__he(body,"borderTopWidth");
}return {left:left,top:top};
},"webkit":function(elem){var doc=qx.dom.Node.getDocument(elem);
var body=doc.body;
var left=body.offsetLeft;
var top=body.offsetTop;
if(qx.bom.client.Engine.VERSION<530.17){left+=this.__he(body,"borderLeftWidth");
top+=this.__he(body,"borderTopWidth");
}return {left:left,top:top};
},"gecko":function(elem){var body=qx.dom.Node.getDocument(elem).body;
var left=body.offsetLeft;
var top=body.offsetTop;
if(qx.bom.client.Engine.VERSION<1.9){left+=this.__he(body,"marginLeft");
top+=this.__he(body,"marginTop");
}if(qx.bom.element.BoxSizing.get(body)!=="border-box"){left+=this.__he(body,"borderLeftWidth");
top+=this.__he(body,"borderTopWidth");
}return {left:left,top:top};
...
var top=body.offsetTop;
return {left:left,top:top};
}}),__hh:qx.core.Variant.select("qx.client",{"mshtml|webkit":function(elem){var doc=qx.dom.Node.getDocument(elem);
...
top+=elem.offsetTop;
left+=this.__he(elem,"borderLeftWidth");
top+=this.__he(elem,"borderTopWidth");
elem=elem.offsetParent;
}}return {left:left,top:top};
...
if(box.get(elem)!=="border-box"){left-=this.__he(elem,"borderLeftWidth");
top-=this.__he(elem,"borderTopWidth");
}
while(elem&&elem!==body){left+=elem.offsetLeft;
top+=elem.offsetTop;
if(box.get(elem)!=="border-box"){left+=this.__he(elem,"borderLeftWidth");
top+=this.__he(elem,"borderTopWidth");
}if(elem.parentNode&&this.__hd(elem.parentNode,"overflow")!="visible"){left+=this.__he(elem.parentNode,"borderLeftWidth");
top+=this.__he(elem.parentNode,"borderTopWidth");
}elem=elem.offsetParent;
}}return {left:left,top:top};
...
}}),get:function(elem,mode){if(elem.tagName=="BODY"){var location=this.__hi(elem);
...
if(overX=="scroll"||overX=="auto"){right+=elem.scrollWidth-elem.offsetWidth+this.__he(elem,"borderLeftWidth")+this.__he(elem,"borderRightWidth");
}var overY=qx.bom.element.Overflow.getY(elem);

if(overY=="scroll"||overY=="auto"){bottom+=elem.scrollHeight-elem.offsetHeight+this.__he(elem,"borderTopWidth")+this.__he(elem,"borderBottomWidth");
}}
switch(mode){case "padding":left+=this.__he(elem,"paddingLeft");
top+=this.__he(elem,"paddingTop");
right-=this.__he(elem,"paddingRight");
bottom-=this.__he(elem,"paddingBottom");
case "scroll":left-=elem.scrollLeft;
top-=elem.scrollTop;
right-=elem.scrollLeft;
bottom-=elem.scrollTop;
case "border":left+=this.__he(elem,"borderLeftWidth");
top+=this.__he(elem,"borderTopWidth");
right-=this.__he(elem,"borderRightWidth");
bottom-=this.__he(elem,"borderBottomWidth");
break;
case "margin":left-=this.__he(elem,"marginLeft");
top-=this.__he(elem,"marginTop");
right+=this.__he(elem,"marginRight");
bottom+=this.__he(elem,"marginBottom");
break;
}}return {left:left,top:top,right:right,bottom:bottom};
},__hi:qx.core.Variant.select("qx.client",{"default":function(body){var top=body.offsetTop+this.__he(body,"marginTop");
var left=body.offsetLeft+this.__he(body,"marginLeft");
return {left:left,top:top};
},"mshtml":function(body){var top=body.offsetTop;
var left=body.offsetLeft;

if(!((qx.bom.client.Engine.VERSION<8||qx.bom.client.Engine.DOCUMENT_MODE<8)&&!qx.bom.client.Feature.QUIRKS_MODE)){top+=this.__he(body,"marginTop");
left+=this.__he(body,"marginLeft");
}return {left:left,top:top};
},"gecko":function(body){var top=body.offsetTop+this.__he(body,"marginTop")+this.__he(body,"borderLeftWidth");
var left=body.offsetLeft+this.__he(body,"marginLeft")+this.__he(body,"borderTopWidth");
return {left:left,top:top};
...
qx.Class.define("qx.ui.core.queue.Widget",{statics:{__hj:{},remove:function(widget){delete this.__hj[widget.$$hash];
...
qx.Class.define("qx.ui.core.queue.Visibility",{statics:{__hk:{},__hl:{},remove:function(widget){var hash=widget.$$hash;
...
qx.Class.define("qx.ui.core.queue.Appearance",{statics:{__hn:{},remove:function(widget){delete this.__hn[widget.$$hash];
...
qx.Class.define("qx.ui.core.queue.Dispose",{statics:{__ho:{},add:function(widget){var queue=this.__ho;
...
qx.Bootstrap.define("qx.bom.client.Locale",{statics:{LOCALE:"",VARIANT:"",__hu:function(){var locale=(qx.bom.client.Engine.MSHTML?navigator.userLanguage:navigator.language).toLowerCase();
var variant="";
...
}},properties:{locale:{check:"String",nullable:true,apply:"_applyLocale",event:"changeLocale"}},members:{__hA:"C",__hB:null,__hC:null,__hy:null,__hz:null,getLanguage:function(){return this.__hC;
...
qx.Class.define("qx.ui.basic.Image",{extend:qx.ui.core.Widget,construct:function(source){this.__hE={};
arguments.callee.base.call(this);

if(source){this.setSource(source);
}},properties:{source:{check:"String",init:null,nullable:true,event:"changeSource",apply:"_applySource",themeable:true},scale:{check:"Boolean",init:false,themeable:true,apply:"_applyScale"},appearance:{refine:true,init:"image"},allowShrinkX:{refine:true,init:false},allowShrinkY:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false}},members:{__hF:null,__hG:null,__hH:null,__hE:null,getContentElement:function(){return this.__hL();
...
if(this.getScale()&&isPng&&qx.bom.element.Decoration.isAlphaImageLoaderEnabled()){this.__hH="alphaScaled";
}else if(this.getScale()){this.__hH="scaled";
}else{this.__hH="nonScaled";
}}return this.__hH;
...
}},__hM:qx.core.Variant.select("qx.client",{"mshtml":function(source){var alphaImageLoader=qx.bom.element.Decoration.isAlphaImageLoaderEnabled();
var isPng=qx.lang.String.endsWith(source,".png");

if(alphaImageLoader&&isPng){if(this.getScale()&&this.__hJ()!="alphaScaled"){this.__hI("alphaScaled");
}else if(!this.getScale()&&this.__hJ()!="nonScaled"){this.__hI("nonScaled");
}}else{if(this.getScale()&&this.__hJ()!="scaled"){this.__hI("scaled");
}else if(!this.getScale()&&this.__hJ()!="nonScaled"){this.__hI("nonScaled");
}}this.__hN(this.__hL());
},"default":function(source){if(this.getScale()&&this.__hJ()!="scaled"){this.__hI("scaled");
}else if(!this.getScale()&&this.__hJ("nonScaled")){this.__hI("nonScaled");
}this.__hN(this.__hL());
...
this.__hG=height;
qx.ui.core.queue.Layout.add(this);
}}},destruct:function(){this._disposeMap("__hE");
}});
...
timer.start();
this.__hT=timer;
},events:{"interval":"qx.event.type.Event"},properties:{timeoutInterval:{check:"Number",init:100,apply:"_applyTimeoutInterval"}},members:{__hT:null,_applyTimeoutInterval:function(value){this.__hT.setInterval(value);
...
},properties:{axisX:{check:"qx.util.placement.AbstractAxis"},axisY:{check:"qx.util.placement.AbstractAxis"},edge:{check:["top","right","bottom","left"],init:"top"},align:{check:["top","right","bottom","left"],init:"right"}},statics:{__hV:null,compute:function(size,area,target,offsets,position,modeX,modeY){this.__hV=this.__hV||new qx.util.placement.Placement();
...
},__hW:null,__hX:null,__hY:null,__ia:function(mode){switch(mode){case "direct":this.__hW=this.__hW||new qx.util.placement.DirectAxis();
return this.__hW;
case "keep-align":this.__hX=this.__hX||new qx.util.placement.KeepAlignAxis();
return this.__hX;
case "best-fit":this.__hY=this.__hY||new qx.util.placement.BestFitAxis();
return this.__hY;
...
}}},destruct:function(){this._disposeObjects('__hU');
}});
...
this.__id={};
qx.event.Registration.addListener(document.documentElement,"mousedown",this.__if,this,true);
...
}}},destruct:function(){qx.event.Registration.removeListener(document.documentElement,"mousedown",this.__if,this,true);
this._disposeMap("__id");
}});
qx.Class.define("qx.ui.layout.Abstract",{type:"abstract",extend:qx.core.Object,members:{__ig:null,_invalidChildrenCache:null,__ih:null,invalidateLayoutCache:function(){this.__ig=null;
...
}},properties:{rich:{check:"Boolean",init:false,event:"changeRich",apply:"_applyRich"},wrap:{check:"Boolean",init:true,apply:"_applyWrap"},value:{check:"String",apply:"_applyValue",event:"changeValue",nullable:true},buddy:{check:"qx.ui.core.Widget",apply:"_applyBuddy",nullable:true,init:null},textAlign:{check:["left","center","right"],nullable:true,themeable:true,apply:"_applyTextAlign",event:"changeTextAlign"},appearance:{refine:true,init:"label"},selectable:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false},allowShrinkY:{refine:true,init:false}},members:{__ii:null,__ij:null,__ik:null,__il:null,_getContentHint:function(){if(this.__ij){this.__im=this.__in();
delete this.__ij;
...
if(value!=null){this.__ik=value.bind("enabled",this,"enabled");
this.__il=this.addListener("click",value.focus,value);
...
qx.Class.define("qx.html.Label",{extend:qx.html.Element,members:{__io:null,_applyProperty:function(name,value){arguments.callee.base.call(this,name,value);
...
qx.Class.define("qx.bom.Label",{statics:{__ip:{fontFamily:1,fontSize:1,fontWeight:1,fontStyle:1,lineHeight:1},__iq:function(){var el=this.__is(false);
document.body.insertBefore(el,document.body.firstChild);
return this._textElement=el;
},__ir:function(){var el=this.__is(true);
document.body.insertBefore(el,document.body.firstChild);
return this._htmlElement=el;
},__is:function(html){var el=qx.bom.Element.create("div");
var style=el.style;
...
for(var key in this.__ip){inner.style[key]="inherit";
...
for(var key in this.__ip){xulel.style[key]="inherit";
...
qx.Mixin.define("qx.ui.core.MBlocker",{construct:function(){this.__iw=new qx.ui.core.Blocker(this);
},properties:{blockerColor:{check:"Color",init:null,nullable:true,apply:"_applyBlockerColor",themeable:true},blockerOpacity:{check:"Number",init:1,apply:"_applyBlockerOpacity",themeable:true}},members:{__iw:null,_applyBlockerColor:function(value,old){this.__iw.setColor(value);
...
}},destruct:function(){this._disposeObjects("__iw");
}});
qx.Mixin.define("qx.ui.window.MDesktop",{properties:{activeWindow:{check:"qx.ui.window.Window",apply:"_applyActiveWindow",init:null,nullable:true}},members:{__ix:null,__iy:null,getWindowManager:function(){if(!this.__iy){this.setWindowManager(new qx.ui.window.Window.DEFAULT_MANAGER_CLASS());
}return this.__iy;
...
}},destruct:function(){this._disposeArray("__ix");
this._disposeObjects("__iy");
}});
...
qx.Class.define("qx.ui.root.Application",{extend:qx.ui.root.Abstract,construct:function(doc){this.__iA=qx.dom.Node.getWindow(doc);
this.__iB=doc;
arguments.callee.base.call(this);
qx.event.Registration.addListener(this.__iA,"resize",this._onResize,this);
...
if(this._isPageRoot){widget.addListener("resize",this.__iL,this);
}this.__iC=[];
this.__iD=[];
this.__iE=[];
},properties:{color:{check:"Color",init:null,nullable:true,apply:"_applyColor",themeable:true},opacity:{check:"Number",init:1,apply:"_applyOpacity",themeable:true}},members:{__iF:null,__iG:0,__iH:null,__iE:null,__iC:null,__iD:null,__iI:null,__iJ:0,__iK:null,_isPageRoot:false,_widget:null,__iL:function(e){var data=e.getData();
...
this.__iM("backgroundColor",color);
},_applyOpacity:function(value,old){this.__iM("opacity",value);
...
blocker.include();
blocker.activate();
blocker.addListener("deactivate",this.__iS,this);
blocker.addListener("keypress",this.__iR,this);
blocker.addListener("keydown",this.__iR,this);
blocker.addListener("keyup",this.__iR,this);
...
var blocker=this.getBlockerElement();
blocker.removeListener("deactivate",this.__iS,this);
blocker.removeListener("keypress",this.__iR,this);
blocker.removeListener("keydown",this.__iR,this);
blocker.removeListener("keyup",this.__iR,this);
blocker.exclude();
...
this.__iK.addListener("interval",this.__iQ,this);
}this.__iK.start();
this.__iQ();
...
},__iR:function(e){if(e.getKeyIdentifier()=="Tab"){e.stop();
}},__iS:function(){this.getBlockerElement().activate();
}},destruct:function(){if(this._isPageRoot){this._widget.removeListener("resize",this.__iL,this);
}this._disposeObjects("__iH","__iF","__iK");
...
}this.addListener("appear",this.__iT,this);
this.addListener("disappear",this.__iT,this);
},members:{_stopPropagation:function(e){e.stopPropagation();
},__iT:function(){var currentCursor=this.getStyle("cursor");
...
this.__iU={};
},members:{__iU:null,__iV:null,__iW:null,__iX:null,connectTo:function(root){root.addListener("keypress",this.__iY,this);
...
}},__iY:function(e){if(e.getKeyIdentifier()!="Tab"){return;
}
if(!this.__iX){return;
}e.stopPropagation();
e.preventDefault();
...
}},destruct:function(){this._disposeMap("__iU");
...
qx.Mixin.define("qx.ui.core.MExecutable",{events:{"execute":"qx.event.type.Event"},properties:{command:{check:"qx.ui.core.Command",apply:"_applyCommand",event:"changeCommand",nullable:true}},members:{__jk:null,_bindableProperties:["enabled","label","icon","toolTipText","value","menu"],execute:function(){var cmd=this.getCommand();
