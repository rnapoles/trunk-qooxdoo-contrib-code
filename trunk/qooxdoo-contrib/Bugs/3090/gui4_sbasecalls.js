...
qx.Class.define("qx.ui.decoration.Grid",{extend:qx.ui.decoration.Abstract,construct:function(baseImage,insets){this.base(arguments);
...
qx.Class.define("gui4.Application",{extend:qx.application.Standalone,members:{main:function(){this.base(arguments);
{};
...
},serialize:function(){var result=this.base(arguments);
var props=this.__layoutProperties;
...
{};
return element;
},toString:function(){return this.base(arguments);
...
qx.Class.define("qx.html.Element",{extend:qx.core.Object,construct:function(tagName){this.base(arguments);
...
qx.Class.define("qx.html.Decorator",{extend:qx.html.Element,construct:function(decorator,decoratorId){this.base(arguments);
...
qx.Class.define("qx.html.Blocker",{extend:qx.html.Element,construct:function(backgroundColor,opacity){this.base(arguments);
