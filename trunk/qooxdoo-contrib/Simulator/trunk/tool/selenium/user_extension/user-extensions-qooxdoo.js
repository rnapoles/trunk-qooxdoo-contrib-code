...
/**
 * Returns a widget's unique ID as generated by qx.core.ObjectRegistry
 * 
 * @param {String} locator to find the widget
 * @return {String} the object's hash code
 */
Selenium.prototype.getQxObjectHash = function(locator)
{
  var qxObject = this.getQxWidgetByLocator(locator);  
  if (!qxObject) {
    throw new SeleniumError("No qooxdoo object found for locator: " + locator);
