qx.Class.define("silverbluetheme.demo.Menu",
{
  ...
  */
  ...
  members:
  {
    ...
    _createControls: function()
    {
      ...
      container.add(menubar, {left: 20, top: 100});

      this.setContextMenu(this.getRootContextMenu());
	  
	  //////////////////////// Decorator stuff
	  var controlGrid = new qx.ui.layout.Grid(10, 10);
      var controlContainer = new qx.ui.container.Composite(controlGrid);
	  
	  container.add(controlContainer, {left: 20, top: 140});
