qx.Class.define("silverbluetheme.demo.GroupBox",
{
  ...
  */
  ...
  members:
  {
    _createControls: function()
    {
      ...
      var box3 = this.box3 = new qx.ui.groupbox.RadioGroupBox("Custom Settings");
      box3.setLayout(new qx.ui.layout.VBox(5));
      box3Helper.add(box3);

      new qx.ui.form.RadioGroup(radioButton1, box3);
	  
	  var label3 = new qx.ui.basic.Label("Decorator");

	  var radioButton2 = new qx.ui.form.RadioButton("box-silver");
	  var radioButton3 = new qx.ui.form.RadioButton("box-blue");
	  var radioButton4 = new qx.ui.form.RadioButton("box-white");
	  var radioButton5 = new qx.ui.form.RadioButton("box-gradient");
	  
	  box3.add(label3);
	  box3.add(radioButton2);
      box3.add(radioButton3);
      box3.add(radioButton4);
      box3.add(radioButton5);
	  
	  box3.addListener("changeValue", function(e)
	  {
	    if (!e.getData())
		{
	  ...
	  var radioGroup1 = new qx.ui.form.RadioGroup(radioButton2, radioButton3, radioButton4, radioButton5);
	  radioGroup1.addListener("changeSelection", function(e)
	  {
	    box3.getChildControl("frame").setDecorator(e.getData()[0].getLabel());
	  }, this);
    }
  }
