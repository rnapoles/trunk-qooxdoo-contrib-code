qx.Class.define("silverbluetheme.demo.EditorWindow",
{
  ...
  */
  ...
  members :
  {
    _createControls: function()
    {
      ...
      qx.util.ResourceManager.getInstance().toUri("silverbluetheme.demo/editor/blank.html"));
    ...
    getToolbarEntries : function()
    {
      return [
        {
          bold:                { text: "Format Bold", image: "qx/icon/Tango/16/actions/format-text-bold.png", action: this.editor.setBold },
          italic:              { text: "Format Italic", image: "qx/icon/Tango/16/actions/format-text-italic.png", action: this.editor.setItalic },
          underline:           { text: "Format Underline", image: "qx/icon/Tango/16/actions/format-text-underline.png", action: this.editor.setUnderline },
          strikethrough:       { text: "Format Strikethrough", image: "qx/icon/Tango/16/actions/format-text-strikethrough.png", action: this.editor.setStrikeThrough },
          removeFormat:        { text: "Remove Format", image: "qx/icon/Tango/16/actions/edit-clear.png", action: this.editor.removeFormat }
        },

        {
          alignLeft:           { text: "Align Left", image: "qx/icon/Tango/16/actions/format-justify-left.png", action: this.editor.setJustifyLeft },
          alignCenter:         { text: "Align Center", image: "qx/icon/Tango/16/actions/format-justify-center.png", action: this.editor.setJustifyCenter },
          alignRight:          { text: "Align Right", image: "qx/icon/Tango/16/actions/format-justify-right.png", action: this.editor.setJustifyRight },
          alignJustify:        { text: "Align Justify", image: "qx/icon/Tango/16/actions/format-justify-fill.png", action: this.editor.setJustifyFull }
        },

        {
          fontFamily:          { custom: this.__fontFamilyToolbarEntry },
          fontSize:            { custom: this.__fontSizeToolbarEntry },
          fontColor:           { text: "Set Text Color", image:  "silverbluetheme.demo/editor/format-text-color.png", action: this.__fontColorHandler },
          textBackgroundColor: { text: "Set Text Background Color", image:  "silverbluetheme.demo/editor/format-fill-color.png", action: this.__textBackgroundColorHandler }
        },

        {
          indent:              { text: "Indent More", image: "qx/icon/Tango/16/actions/format-indent-more.png", action: this.editor.insertIndent },
          outdent:             { text: "Indent Less", image: "qx/icon/Tango/16/actions/format-indent-less.png", action: this.editor.insertOutdent }
        },


        {
          insertImage:         { text: "Insert Image", image: "qx/icon/Tango/16/actions/insert-image.png", action: this.__insertImageHandler },
          insertTable:         { text: "Insert Table", image: "silverbluetheme.demo/editor/insert-table.png", action: this.__insertTableHandler },
          insertLink:          { text: "Insert Link", image: "qx/icon/Tango/16/actions/insert-link.png", action: this.__insertLinkHandler },
          insertHTML:          { text: "Insert HTML Code", image: "silverbluetheme.demo/editor/insert-text.png", action: this.__insertHTMLHandler },
          insertHR:            { text: "Insert Horizontal Ruler", image: "silverbluetheme.demo/editor/insert-horizontal-rule.png", action: this.editor.insertHorizontalRuler }
        },

        {
          ol:                  { text: "Insert Ordered List", image: "silverbluetheme.demo/editor/format-list-ordered.png", action: this.editor.insertOrderedList },
          ul:                  { text: "Inserted Unordered List", image: "silverbluetheme.demo/editor/format-list-unordered.png", action: this.editor.insertUnorderedList }
        },

        {
          undo:                { text: "Undo Last Change", image: "qx/icon/Tango/16/actions/edit-undo.png", action: this.editor.undo },
          redo:                { text: "Redo Last Undo Step", image: "qx/icon/Tango/16/actions/edit-redo.png", action: this.editor.redo }
        }
      ];
    },
  ...
  /* *********************************************
    ...
    {
      var attributes = { src    : qx.util.ResourceManager.getInstance().toUri("silverbluetheme.demo/logo.png"),
                         border : 0,
                         title  : "qooxdoo logo",
                         alt    : "qooxdoo logo" };
