// §{header}:
// 
// This is file src/de/mlhartme/mork/classfile/ClassRef.java,
...
public class ClassRef implements Bytecodes, Constants {
    //----------------------------------------------------------------
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ClassRef) {
            r = (ClassRef) obj;
            return (dimensions == r.dimensions) &&
    ...
    public Class lookup() {
        ...
        for (count = dimensions; count > 0; count--) {
            result = de.mlhartme.mork.reflect.Arrays.getArrayClass(result);
        }
        return result;
    }
    ...
    public static Class read(ObjectInput in)
        ...
        if (dim == -1) {
            ...
            while (dim-- > 0) {
                ...
                cl = de.mlhartme.mork.reflect.Arrays.getArrayClass(cl);
            }
            return cl;
        }
    }
