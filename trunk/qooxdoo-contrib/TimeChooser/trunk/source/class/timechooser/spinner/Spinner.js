 ...
 * var s = new timechooser.spinner.Spinner();
 * s.set({
 *   max: 3000,
 *   min: -3000
 * });
 ...
 *
 * This widget differs from qx.ui.form.Spinner in that it provides
 * extensibility through the transform key of the 'value' property.
 */
qx.Class.define("timechooser.spinner.Spinner",
{
