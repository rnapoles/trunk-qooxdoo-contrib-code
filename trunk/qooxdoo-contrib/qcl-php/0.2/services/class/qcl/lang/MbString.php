...
class qcl_MbString
{
  ...
  /**
   * Convert the string to the given character set
   * @param string $to_encoding
   * @return string
   */
  public function convert( $to_encoding )
  {
    return mb_convert_encoding ($this->string, $to_encoding );
  }
  ...
  /**
   * Adds a string or cql_MbString.
   * @param string|cql_MbString $value
   * @return void
   */
  public function concat( $value )
  {
    if ( gettype( $value ) === "string" or $value instanceof cql_MbString )
    {
      $this->string .= (string) $value;
    }
    else
    {
      throw new InvalidArgumentException("Argument must be string or cql_MbString");
    }
  }
