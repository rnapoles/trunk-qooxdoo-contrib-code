...
class class_test
{
     ...
     */
/*
    public function GetAccessibility($method, $defaultAccessibility)
    {
        switch($method)
        {
        case "echo":
...
*/
     ...
     *   Failure: null
     */
    public function method_echo($params, $error)
    {
        if (count($params) != 1)
        {
     ...
     *   "Never"
     */
    public function method_sink($params, $error)
    {
     ...
     *   Failure: null
     */
    public function method_sleep($params, $error)
    {
        if (count($params) != 1)
        {
            $error->SetError(JsonRpcError_ParameterMismatch,
    ...
    public function method_getInteger($params, $error)
    {
        return 1;
    }
    
    public function method_getFloat($params, $error)
    {
        return 1/3;
    }
    
    public function method_getString($params, $error)
    {
        return "Hello world";
    }
    
    public function method_getBadString($params, $error)
    {
        return "<!DOCTYPE HTML \"-//IETF//DTD HTML 2.0//EN\">";
    }
    
    public function method_getArrayInteger($params, $error)
    {
        return array(1, 2, 3, 4);
    }
    
    public function method_getArrayString($params, $error)
    {
        return array("one", "two", "three", "four");
    }
    
    public function method_getObject($params, $error)
    {
        return new JSON(); // some arbitrary object
    }
    
    public function method_getTrue($params, $error)
    {
        return true;
    }
    
    public function method_getFalse($params, $error)
    {
        return false;
    }
    
    public function method_getNull($params, $error)
    {
        return null;
    }

    public function method_isInteger($params, $error)
    {
        return is_int($params[0]);
    }
    
    public function method_isFloat($params, $error)
    {
        return is_float($params[0]);
    }
    
    public function method_isString($params, $error)
    {
        return is_string($params[0]);
    }
    
    public function method_isBoolean($params, $error)
    {
        return is_bool($params[0]);
    }
    
    public function method_isArray($params, $error)
    {
        return is_array($params[0]);
    }
    
    public function method_isObject($params, $error)
    {
        return is_object($params[0]);
    }
    
    public function method_isNull($params, $error)
    {
        return is_null($params[0]);
    }
    
    public function method_getParams($params, $error)
    {
        return $params;
    }	
    
    public function method_getParam($params, $error)
    {
        return $params[0];
    }	
    
    public function method_getCurrentTimestamp()
    {
        $now = time();
        $obj = new stdClass();
        $obj->now = $now;
    ...
    public function getErrorThrown($params)
    {
    ...
    // utility function used by method_getError()
    public function getErrorTraditional($params, $error)
    {
    ...
    public function method_getError($params, $error)
    {
