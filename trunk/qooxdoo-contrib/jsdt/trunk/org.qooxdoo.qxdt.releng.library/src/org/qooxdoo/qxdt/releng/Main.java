 ...
 * construct such a directory:</br> <code>BLA=`find . -name "*.js"`</code><br/>
 * <code>for II in $BLA; do NEWNAME=`echo ${II} | sed 's/\//_/g' | sed 's/^\._//'`; echo "${II} -> ${NEWNAME}"; cp ${II} /tmp/qxclasses/${NEWNAME}; done</code>
 * 
