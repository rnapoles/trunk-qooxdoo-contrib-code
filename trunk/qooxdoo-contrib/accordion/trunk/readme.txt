...
from MS Outlook or similar programs.
...
Important Info!
The accordion constructor expects the Window the accordion will be displayed
in as parameter. This is used to determine the size available to display the 
...
on http://training.simply-notes.de - than you need to provide the viewport to 
