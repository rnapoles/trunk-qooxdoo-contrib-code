  ...
  */
  ...
  statics :
  {
    ...
    __getHtml : function(root, outputRoot, skipHtmlEncoding, postProcess)
    {
      ...
      switch(root.nodeType)
      {
        ...
        case 11:
          ...
          var closed = (!(root.hasChildNodes() || htmlarea.HtmlAreaNative.__needsClosingTag(root)));
          ...
          if (outputRoot)
          {
            ...
            {
              styles = htmlarea.HtmlAreaNative.__parseStyle(attributes.style);
    ...
    __needsClosingTag : function(el) {
      return (htmlarea.HtmlAreaNative.closingTags.indexOf(" " + el.tagName + " ") != -1);
    },
