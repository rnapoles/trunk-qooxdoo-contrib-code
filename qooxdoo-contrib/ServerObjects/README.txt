...
Please read the QRJO.doc - it includes a section "Exploring the code" that will help
you read the examples and tests.


1. Get Qooxdoo and add it to the demo project
---------------------------------------------
Because Qooxdoo is a large download it is not included in the QRJO .zip file and you have
to add it yourself; download Qooxdoo v1.0.1 (or the latest version) and unpack it into
a folder called qooxdoo in the same place you unpacked QRJO.

For example, if you unpacked to "d:\dev\qrjo" your directory structure should now look 
like this:
...
root directory to the folder you unzipped to (E.G. d:\dev\qrjo) and click finish.


3. Configure directories
------------------------
If you unpacked into d:\dev\qrjo (I.E. the example folder layout above) you can skip this
...
is mapped to "D:\dev\qrjo\WebContent\demoapp\source\index.html".

Open the file WebContent\WEB-INF\web.xml and change the three <init-param> entries to
refer to your path instead of "D:/dev/qrjo".  **NOTE** You must use Unix-style paths even on
...
---------------------
In a command prompt cd to "D:\dev\qrjo\WebContent\demoapp" and type ".\generate source" and/or
...
5. Run the demo app
-------------------
You should now be able to browse to http://localhost/qrjo/demoapp/source/index.html or to
http://localhost/qrjo/demoapp/build/index.html depending on which generator function you 
