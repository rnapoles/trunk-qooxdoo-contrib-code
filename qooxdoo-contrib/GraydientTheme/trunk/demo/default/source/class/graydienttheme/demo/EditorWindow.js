qx.Class.define("graydienttheme.demo.EditorWindow",
{
  ...
  */
  ...
  members :
  {
    _createControls: function()
    {
      ...
      this.set({layout: layout, contentPadding: 0, showStatusbar: true});
      ...
      qx.util.ResourceManager.getInstance().toUri("graydienttheme.demo/editor/blank.html"));
    ...
    getToolbarEntries : function()
    {
      return [
...

        {
          ...
          fontColor:           { text: "Set Text Color", image:  "graydienttheme.demo/editor/format-text-color.png", action: this.__fontColorHandler },
          textBackgroundColor: { text: "Set Text Background Color", image:  "graydienttheme.demo/editor/format-fill-color.png", action: this.__textBackgroundColorHandler }
        },
...

        {
          ...
          insertTable:         { text: "Insert Table", image: "graydienttheme.demo/editor/insert-table.png", action: this.__insertTableHandler },
          insertLink:          { text: "Insert Link", image: "icon/16/actions/insert-link.png", action: this.__insertLinkHandler },
          insertHTML:          { text: "Insert HTML Code", image: "graydienttheme.demo/editor/insert-text.png", action: this.__insertHTMLHandler },
          insertHR:            { text: "Insert Horizontal Ruler", image: "graydienttheme.demo/editor/insert-horizontal-rule.png", action: this.editor.insertHorizontalRuler }
        },

        {
          ol:                  { text: "Insert Ordered List", image: "graydienttheme.demo/editor/format-list-ordered.png", action: this.editor.insertOrderedList },
          ul:                  { text: "Inserted Unordered List", image: "graydienttheme.demo/editor/format-list-unordered.png", action: this.editor.insertUnorderedList }
        },
  ...
  /* *********************************************
    ...
    {
      var attributes = { src    : qx.util.ResourceManager.getInstance().toUri("graydienttheme.demo/logo.png"),
                         border : 0,
                         title  : "qooxdoo logo",
                         alt    : "qooxdoo logo" };
