...
qx.Class.define("qcl.access.AccessManager",
{
  ...
  */
  ...
  properties : {
     ...
     /**
      * Whether logout creates a new anonymous user
      * @type 
      */
     logoutCreatesAnonymous :
     {
        check : "Boolean",
        init  : false
     }
  ...
  */
  ...
  members :
  {
    ...
    */    
    ...
    {
      this.getStore().load("logout", [this.getLogoutCreatesAnonymous()], callback, context );
    }
   
  },
  
  /**
   * FIXME temporary hack to include md5 functions. will be included more cleanly later
   */
  defer: function()
  {
    /*
