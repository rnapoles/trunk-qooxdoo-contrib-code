  ...
  */
  ...
  members :
  {
    ...
    main : function()
    {
      ...
      this.treeWidget.setSelectionMode(
      ...
      this.buttonAddSibling.addListener(
        "execute",
        function(e)
        {
          var selectedNode = this.treeWidget.getSelectedNodes()[0];
      ...
      this.buttonAddRaw.addListener(
        ...
        function(e)
        {
          ...
          this.treeWidget.getDataModel().addTreeData( 
              selectedNodes.length ? selectedNodes[0].nodeId : 0, 
              treeData 
          );
