...
<%doc>
  ...
  === result ===
  var qcldepencency1 = qcl.access.PermissionManager.getInstance().create("myPermission");
...
var ${utils.rawAttrib("id")} = qcl.access.PermissionManager.getInstance().create(${utils.attrib("permission")});
