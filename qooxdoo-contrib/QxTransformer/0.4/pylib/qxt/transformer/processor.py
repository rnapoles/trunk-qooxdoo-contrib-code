...
class Processor:
    ...
    def __init__(self, dialect):
        ...
        logd.debug("Getting configuration for dialect %s." %dialect)
        
        #loading dialect settings
        settings.DialectSettings().load(dialect)
    ...
    def __getClassName__(self, rootElement):
        """docstring for __getClassName"""
        return tree.getroot().attrib(self.__dialectSettings__.getClassNameAttr())
