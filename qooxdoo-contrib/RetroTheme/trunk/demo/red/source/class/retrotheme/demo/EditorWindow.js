qx.Class.define("retrotheme.demo.EditorWindow",
{
  ...
  */
  ...
  getToolbarEntries : function()
    {
      return [
...

        {
          ...
          fontColor:           { text: "Set Text Color", image:  "retrotheme.demo/editor/format-text-color.png", action: this.__fontColorHandler },
          textBackgroundColor: { text: "Set Text Background Color", image:  "retrotheme.demo/editor/format-fill-color.png", action: this.__textBackgroundColorHandler }
        },
...

        {
          ...
          insertTable:         { text: "Insert Table", image: "retrotheme.demo/editor/insert-table.png", action: this.__insertTableHandler },
          insertLink:          { text: "Insert Link", image: "qx/icon/Oxygen/16/actions/insert-link.png", action: this.__insertLinkHandler },
          insertHTML:          { text: "Insert HTML Code", image: "retrotheme.demo/editor/insert-text.png", action: this.__insertHTMLHandler },
          insertHR:            { text: "Insert Horizontal Ruler", image: "retrotheme.demo/editor/insert-horizontal-rule.png", action: this.editor.insertHorizontalRuler }
        },

        {
          ol:                  { text: "Insert Ordered List", image: "retrotheme.demo/editor/format-list-ordered.png", action: this.editor.insertOrderedList },
          ul:                  { text: "Inserted Unordered List", image: "retrotheme.demo/editor/format-list-unordered.png", action: this.editor.insertUnorderedList }
        },
  ...
  /* *********************************************
    ...
    {
      var attributes = { src    : qx.util.ResourceManager.getInstance().toUri("retrotheme/logo.png"),
                         border : 0,
                         title  : "qooxdoo logo",
                         alt    : "qooxdoo logo" };
