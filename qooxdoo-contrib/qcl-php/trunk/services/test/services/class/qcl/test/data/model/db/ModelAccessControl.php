...
class class_qcl_test_data_model_db_ModelAccessControl
  extends qcl_test_AbstractTestController
{
  ...
  public function method_testModel()
  {
    ...
    try
    {
      ...
      $result =  $this->method_fetchRecords( "acl_test", "personaldata", $queryData );
      $this->assertEquals( array(),$result,null,__CLASS__,__LINE__);
      ...
      $result =  $this->method_fetchRecords( "acl_test", "personaldata", $queryData );
      $id = $result[0]['id'];
      $this->assertEquals( 14, $id, null, __CLASS__, __LINE__);

      /*
       * now she knows the id, she can directly access the value
       */
      $data = $this->method_getValue( "acl_test", "personaldata", $id, "data" );
      $this->assertEquals( "Akiko's Password list. Only to be viewed by Akiko!", $data, null, __CLASS__, __LINE__);
      ...
      $data = $this->method_getValue( "acl_test", "personaldata", $id, "data" );
      $this->assertEquals( "new data", $data, null, __CLASS__, __LINE__);
