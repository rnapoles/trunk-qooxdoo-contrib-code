  ...
  extends SimpleXMLElement
{
   ...
   * @param is_prefix bool[optional] Default to false
   ...
   * @param filename string[optional]  If specified, the function writes the data to the file rather than
   * returning it.
