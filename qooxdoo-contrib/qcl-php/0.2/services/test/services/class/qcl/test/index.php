...
/*
 * This script scans this folder and subfolders of the containing
 * folder and looks for classes that extend from qcl_test_AbstractTestController
 * The methods of these classes are checked
 ...
 */
require QCL_CLASS_PATH . "/qcl/test/testdata.php";
?>