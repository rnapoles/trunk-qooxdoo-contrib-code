...
MouseEventParameters.MOUSE_BUTTON_MAPPING_IE = {"left" : 1, "right" : 2, "middle" : 4};
MouseEventParameters.MOUSE_BUTTON_MAPPING_OTHER = {"left" : 0, "right" : 2, "middle" : 1};
...
MouseEventParameters.prototype.getParamValue = function(paramName, defaultValue) {
    ...
    *
    * @param paramName string name of parameter to search for
    * @param defaultValue <different types> default value to be returned, if no value is found
...
Selenium.prototype.doQxClick = function(locator, eventParams) {
   ...
   * @param eventParams additional parameter for the mouse-event to set. e.g. clientX.
