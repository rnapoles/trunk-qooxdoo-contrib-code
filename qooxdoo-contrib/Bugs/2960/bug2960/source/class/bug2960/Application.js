...
/**
 * This is the main application class of your custom application "bug2960"
 */
qx.Class.define("bug2960.Application",
{
  ...
  members :
  {
    ...
    main : function()
    {
      ...
      */
      ...
      // Create a button
      var button1 = new qx.ui.form.Button("First Button", "bug2960/test.png");
      ...
      */
      ...
      // Create a button
      var button2 = new qx.ui.form.Button("First Button", "bug2960/test.png");
