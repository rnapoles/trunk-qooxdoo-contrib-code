...
/**
 * The RpcConsole application. This is a scriptable test client for your JSON-RPC
 ...
 * test data.
 */
qx.Class.define("rpcconsole.Application",
{
...
//      menu.add(mbutton);
       ...
       * initial mode
       */
      var mode = window.location.parameters.mode;
      if ( mode )
      {
        if( qx.lang.Array.contains(["1.0","2.0","non-standard"], mode ) )
        {
          this.getActiveConsole().setMode( mode );
        }
        else
        {
