qx.Class.define("silverbluetheme.demo.List",
{
  ...
  */
  ...
  members:
  {
    _createControls: function()
    {
      ...
      configList.set({ height: 280, width: 150, selectionMode : "multi"/*, textColor: "text-active"*/ });
      ...
      oneList.set({ height: 280, width: 150, selectionMode : "one", textColor: "text-active" });
      var item;
      for( var i=1; i<=25; i++ )
      {
      ...
      additiveList.set({ width: 150, selectionMode : "additive", textColor: "text-active" });
