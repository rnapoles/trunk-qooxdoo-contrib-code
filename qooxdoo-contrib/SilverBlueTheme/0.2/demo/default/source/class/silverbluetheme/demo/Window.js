qx.Class.define("silverbluetheme.demo.Window",
{
  ...
  */
  ...
  _createControls: function()
  {
    ...
    createWindow1 : function()
    {
      ...
      win.open();
      this.desktop.add(win, {left:20, top:20});
    ...
    createWindow2 : function()
    {
      ...
      win.open();
      this.desktop.add(win, {left:350, top:120});
    ...
    createWindow3 : function()
    {
      ...
      win.open();
      this.desktop.add(win, {left:120, top:270});
