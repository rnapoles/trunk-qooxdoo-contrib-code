...
qx.Class.define("ext.strategy.position.CascadeStrategy",
{
  ...
  */
  ...
  construct : function(vOrigin, vWorkspace)
  {
  ...
  */
  ...
  statics :
  {
    ...
    */
    ...
    VERTICAL_DIR_UP      : "up",
    VERTICAL_DIR_DOWN    : "down",
    HORIZONTAL_DIR_LEFT  : "left",
    HORIZONTAL_DIR_RIGHT : "right"
  },
  ...
  members :
  {
    ...
    */
    ...
    position : function(vWidget)
    {
      ...
      // ************************************************************************
      var newWidgetTop = (this._verticalTravel == ext.strategy.position.CascadeStrategy.VERTICAL_DIR_DOWN) ? this._lastTop + ext.strategy.position.CascadeStrategy.TRAVEL : this._lastTop - ext.strategy.position.CascadeStrategy.TRAVEL;

      var newWidgetBottom = newWidgetTop + widgetHeight;

      var newWidgetLeft = (this._horizontalTravel == ext.strategy.position.CascadeStrategy.HORIZONTAL_DIR_RIGHT) ? this._lastLeft + ext.strategy.position.CascadeStrategy.TRAVEL : this._lastLeft - ext.strategy.position.CascadeStrategy.TRAVEL;
      ...
      if (newWidgetTop < wsTop || newWidgetBottom > wsBottom)
      {
        ...
        this._verticalTravel = (this._verticalTravel == ext.strategy.position.CascadeStrategy.VERTICAL_DIR_DOWN) ? ext.strategy.position.CascadeStrategy.VERTICAL_DIR_UP : ext.strategy.position.CascadeStrategy.VERTICAL_DIR_DOWN;
      }

      if (newWidgetLeft < wsLeft || newWidgetRight > wsRight)
      {
        // Switch horizontal travel direction
        this._horizontalTravel = (this._horizontalTravel == ext.strategy.position.CascadeStrategy.HORIZONTAL_DIR_LEFT) ? ext.strategy.position.CascadeStrategy.HORIZONTAL_DIR_RIGHT : ext.strategy.position.CascadeStrategy.HORIZONTAL_DIR_LEFT;
      }

      // ************************************************************************
      //   POSITION WIDGET
      // ************************************************************************
      var yPos = this._lastTop = (this._verticalTravel == ext.strategy.position.CascadeStrategy.VERTICAL_DIR_DOWN) ? this._lastTop + ext.strategy.position.CascadeStrategy.TRAVEL : this._lastTop - ext.strategy.position.CascadeStrategy.TRAVEL;

      var xPos = this._lastLeft = (this._horizontalTravel == ext.strategy.position.CascadeStrategy.HORIZONTAL_DIR_RIGHT) ? this._lastLeft + ext.strategy.position.CascadeStrategy.TRAVEL : this._lastLeft - ext.strategy.position.CascadeStrategy.TRAVEL;
    ...
    */
     ...
     *
     * @type member
     * @param origin {var} TODOC
     * @return {var} TODOC
     */
    _validateOrigin : function(origin)
    {
      var isValidOrigin = false;

      if (origin != null)
      {
        if (origin == ext.strategy.position.CornerStrategy.TOP_LEFT || origin == ext.strategy.position.CornerStrategy.TOP_RIGHT || origin == ext.strategy.position.CornerStrategy.BOTTOM_LEFT || origin == ext.strategy.position.CornerStrategy.BOTTOM_RIGHT) {
          isValidOrigin = true;
        }
      }
