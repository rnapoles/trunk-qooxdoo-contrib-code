...
qx.Class.define("windowdemo.init.Assembler",
{
  type : "singleton",
  ...
  members :
  {
    ...
    */
    ...
    addTitleBar : function()
    {
      ...
      with (tb)
      {
        ...
        setBackgroundColor("window-active-caption");
      }
    ...
    */
    ...
    _getThemesMenu : function()
    {
      ...
      var colourManager = qx.theme.manager.Color.getInstance();
      ...
      var rbm1 = new qx.ui.selection.RadioManager("rbm-colour-theme", themeRadioButtons);

      // Create the icon theme options
      mThemes.add(new qx.ui.menu.Separator);
      var iconThemeLabel = new qx.ui.basic.Label("Icon Theme");

      var imageManager = qx.io.image.Manager.getInstance();
      ...
      var rbm2 = new qx.ui.selection.RadioManager("rbm-icon-theme", iconRadioButtons);
      ...
      var rbm3 = new qx.ui.selection.RadioManager("rbm-atom-theme", atomRadioButtons);
    ...
    */
     ...
     * @return {var} TODOC
     */
    _getNewWindowCommand : function(type)
    {
    ...
    */
     ...
     * @return {var} TODOC
     */
    _focusWindowOfTypeCommand : function(type)
    {
      var c = new qx.client.Command();
      c.setUserData("window-type", type);
     ...
     *
     * @type member
     * @param themeId {var} TODOC
     * @return {var} TODOC
     */
    _getChangeColourThemeCommand : function(themeId)
    {
      var c = new qx.client.Command();
      ...
      c.addEventListener("execute", function(e)
      {
        ...
        qx.theme.manager.Color.getInstance().setColorThemeById(themeId);
      });
     ...
     * @return {var} TODOC
     */
    _getChangeIconThemeCommand : function(themeId)
    {
      var c = new qx.client.Command();
      c.setUserData("theme-id", themeId);
      ...
      {
        var themeId = this.getUserData("theme-id");
        qx.io.image.Manager.getInstance().setIconThemeById(themeId);
      });
     ...
     * @return {var} TODOC
     */
    _getToggleAllAtomsCommand : function(mode)
    {
      var c = new qx.client.Command();
