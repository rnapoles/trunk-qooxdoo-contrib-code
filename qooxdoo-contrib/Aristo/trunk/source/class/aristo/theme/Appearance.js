...
qx.Theme.define("aristo.theme.Appearance",
{
  appearances :
  {
    ...
    "dragdrop-cursor" :
    {
      style : function(states)
      {
        ...
        return {
          source : "aristo/decoration/cursors/" + icon + ".gif",
          position : "right-top",
          offset : [ 2, 16, 2, 6 ]
        };
      }
    ...
    */
    ...
    "checkbox":
    {
      ...
      style : function(states)
      {
        ...
        return {
          icon: "aristo/decoration/form/" + icon + invalid + ".png",
          gap: 6
        };
      }
    },
    ...
    "slider/knob" : 
    {
	 ...
	 "menu" :
	  ...
	  "menu-slidebar/button-backward" :
	  {
	    ...
	    {
	      return {
	        icon : states.hovered ? "aristo/decoration/arrows/up-invert.png" : "aristo/decoration/arrows/up.png"
	      };
	    }
	  },
	  ...
	  "menu-slidebar/button-forward" :
	  {
	    ...
	    {
	      return {
	        icon : states.hovered ? "aristo/decoration/arrows/down-invert.png" : "aristo/decoration/arrows/down.png"
	      };
	    }
	  },
	  ...
	  "menu-button/arrow" :
	  {
	    ...
	    {
	      return {
	        source : states.selected ? "aristo/decoration/arrows/right-invert.png" : "aristo/decoration/arrows/right.png",
	        alignY : "middle"
	      };
	    }
	  },
   ...
   */
   ...
   "splitpane/splitter/knob" :
   {
     ...
     {
       return {
         source : states.horizontal ? "aristo/decoration/splitpane/knob-horizontal.png" : "aristo/decoration/splitpane/knob-vertical.png"
       };
     }
   },
     ...
     style : function(states)
     {
       return {
         ...
         sortIcon  : states.sorted ?
             (states.sortedAscending ? "aristo/decoration/table/ascending.png" : "aristo/decoration/table/descending.png")
             : undefined
       };
     }
   },
