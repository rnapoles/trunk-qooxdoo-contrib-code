/* ************************************************************************
   ...
   This class contains code based on the following work:
	 ...
	 http://www.hanewin.net/encrypt/sha1.js
	 Version 2.1
...
qx.Class.define("openpgp.sha1",
{
   statics : 
  {
	...
	/*
	 * These are the six functions you'll usually want to call
	...
	core_hmac_sha1 : function(key, data)
	{
	  ...
	  var hash = this.core_sha1(ipad.concat(str2binb(data)), 
