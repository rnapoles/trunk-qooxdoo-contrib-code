...
qx.Proto.main = function(e)
{
    ...
    var lw = new qx.ui.window.Window("Login", "icon/16/apps/preferences-desktop-theme.png");
    with(lw) {
        add(gr);
    }
    ...
    var ow = new qx.ui.window.Window("Program", "icon/16/apps/preferences-desktop-theme.png");
    with(ow) {
        add(vb);
    }
