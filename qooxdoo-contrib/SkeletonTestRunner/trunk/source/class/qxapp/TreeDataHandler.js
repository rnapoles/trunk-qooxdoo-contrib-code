...
qx.Class.define("qxapp.TreeDataHandler",
{
  ...
  */
  ...
  members :
  {
    ...
    {
      // current node
      var tree = arguments[1] || new qxapp.Tree(struct.classname);
      var node;
      ...
      {
        node = new qxapp.Tree(struct.tests[j].name);
     ...
     * @return {var} fullName {String} like "qxapp.test.Class.testEmptyClass"
     */
